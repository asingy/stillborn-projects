        ...
        <?php Pjax::begin(); ?>
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    ['attribute'=>'agent_profit','value'=>'agent_profit', 'footer'=>ReportHelper::getPageTotal($dataProvider->models,'agent_profit')],
